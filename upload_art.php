    ...
    if (in_array($videoFileType, $extensions_arr)) {
      ...
      if (($_FILES['file']['size'] >= $maxsize) || ($_FILES["file"]["size"] == 0)) {
        ...
        if (move_uploaded_file($_FILES['file']['tmp_name'], $target_file)) {
          // Insert record
          $query = "INSERT INTO art(`name`,`location`,`title`) VALUES('" . $name . "','" . $target_file . "','$title')";

          mysqli_query($con, $query);
          echo ' <div class="alert alert-success alert-dismissible fade show" role="alert">
              <strong>Success!</strong> Your Art has been posted, will be displayed shortly.
              <p>Your Art will be displayed only after manual approval.</p>
...
<body>
  ...
  <div class="jumbotron bg-dark my-4">
    ...
    <h1 class="display-4 text-secondary" style="font-family: 'Merriweather', serif; ">Upload your Art</h1>


    <form method="post" action="upload_art.php" enctype='multipart/form-data'>
      <div class="form-group">
        ...
        <small id="title" class="form-text  text-secondary">Enter the title less than 15 word's</small>
      </div>
