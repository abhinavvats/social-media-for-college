...
<html>
  <head>
    ...
    if(isset($_POST['but_upload'])){
       ...
       $extensions_arr = array("mp4","avi","3gp","mov","mpeg","png");
       ...
       if( in_array($videoFileType,$extensions_arr) ){
          ...
          if(($_FILES['file']['size'] >= $maxsize) || ($_FILES["file"]["size"] == 0)) {
            ...
            if(move_uploaded_file($_FILES['file']['tmp_name'],$target_file)){
              // Insert record
              $query = "INSERT INTO video(`name`,`location`,`title`) VALUES('".$name."','".$target_file."','$title')";

              mysqli_query($con,$query);
              echo ' <div class="alert alert-success alert-dismissible fade show" role="alert">
              <strong>Success!</strong> Your Video has been posted, will be displayed shortly.
              <p>Your Video will be displayed only after manual approval.</p>
  ...
  <div class="jumbotron bg-dark my-4">
    ...
    <h1 class="display-4 text-secondary" style="font-family: 'Merriweather', serif; ">Upload your videos</h1>
